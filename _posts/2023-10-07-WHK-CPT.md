...
<div class="col-12 mt-12 mt-md-0">
        {% include video.liquid path="https://github.com/hkandjimi-max/hkandjimi-max.github.io/blob/master/assets/video/whk_cpt.mp4?raw=true" class="img-fluid rounded z-depth-1" controls=true autoplay=true %}
</div>